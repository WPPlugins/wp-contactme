...
* ??document??
*****************************************************************************************/
class wv48v_default extends wv48v_action {
	/*******************************************************************
...
*****************************************************************************************/
	public function initWPaction() {
		wp_register_style ( 'v48v_images', $this->application ()->pluginuri () . '/library/base/public/css/images.css', null, $this->application ()->version () );
		wp_register_style ( 'v48v_admin', $this->application ()->pluginuri () . '/library/base/public/css/admin.css', null, $this->application ()->version () );
		wp_register_style ( 'v48v_front', $this->application ()->pluginuri () . '/library/base/public/css/front.css', null, $this->application ()->version () );
		wp_register_style ( 'v48v_common', $this->application ()->pluginuri () . '/library/base/public/css/common.css', null, $this->application ()->version () );
		...
		wp_register_script ( 'v48v_script_js', $this->application ()->pluginuri () . '/library/base/public/js/script.js', null, $this->application ()->version () );
		wv48v_data_settings::setup ($this->application(), ($this->application ()->data('_debug_settings')->debug_settings['settings']!="" || $this->dodebug()) );
		...
		$key = md5(serialize(array('v48v'=>$forms)));
		...
		foreach($forms as $form)
		{
			...
			if(!isset($data['__version__v48v__']))
			{
...
*****************************************************************************************/
	public function admin_enqueue_scriptsWPaction() {
		wp_enqueue_style ( 'v48v_images' );
		wp_enqueue_style ( 'v48v_admin' );
		wp_enqueue_style ( 'v48v_common' );
		$data = array ();
		$data['dodebug'] = $this->dodebug ();
		$data = apply_filters('v48v_data',$data);
		if(isset($data['tinymce']))
		{
			$data['tinymce']['plugin']['name']=$this->application()->slug;
			wp_enqueue_script ( 'jquery' );
			wp_enqueue_script ( 'v48v_script_js' );
			wp_localize_script ( 'v48v_script_js', 'v48v_data', $data );
		}
	}
/*****************************************************************************************
* ??document??
*****************************************************************************************/
	public function wp_enqueue_scriptsWPaction() {
		wp_enqueue_style ( 'v48v_images' );
		wp_enqueue_style ( 'v48v_front' );
		wp_enqueue_style ( 'v48v_common' );
	}
/*	public function wp_enqueue_scriptsWPaction() {
		wp_enqueue_style ( 'jquery-ui_smoothness' );
		wp_enqueue_style ( 'v48v_style_css' );
		wp_enqueue_script ( 'jquery' );
