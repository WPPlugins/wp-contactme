...
* all the admin pages
*****************************************************************************************/
class contactme_admin extends wv48v_action {
/*****************************************************************************************
* ??document??
*****************************************************************************************/
	...
	public function FormsEditAction() {
		...
		$return = '';
		$this->view->body = '<ul class="v48v_field_definitions">';
		...
		foreach($this->view->field_definitions as $key=>$value){
			...
			$this->view->table_type='v48v_'.$value['type']."{$middle}";
			if($value['type']!='new')
			{
				{
...
//		$this->view->body .= '<li>'.$this->render_table().'</li>';
		...
		$this->view->table_type='v48v_general';
...
*****************************************************************************************/
	public function FormsActionMeta($return) {
		...
		$return ['classes'] [] = 'v48v_16x16_form';
		$return ['priority'] = - 1;
		return $return;
	}
