<?php
class contactme_tinymce extends wv48v_action {
	...
	function mce_external_pluginsWPfilter($plugin_array) {
		$plugin_array ['v48v_tinymce'] = $this->application ()->pluginuri () . '/library/base/public/js/tinymce_register.js';
		return $plugin_array;
	}
	public function v48v_dataWPfilter($data)
	{
